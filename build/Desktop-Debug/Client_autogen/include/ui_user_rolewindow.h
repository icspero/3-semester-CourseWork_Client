...
public:
    ...
    void setupUi(QDialog *user_rolewindow)
    {
        ...
        pushButton->setGeometry(QRect(230, 160, 211, 61));
        pushButton_2 = new QPushButton(user_rolewindow);
        pushButton_2->setObjectName("pushButton_2");
        pushButton_2->setGeometry(QRect(230, 240, 211, 61));
        pushButton_3 = new QPushButton(user_rolewindow);
        pushButton_3->setObjectName("pushButton_3");
        pushButton_3->setGeometry(QRect(250, 320, 171, 31));
    ...
    void retranslateUi(QDialog *user_rolewindow)
    {
        ...
        pushButton->setText(QCoreApplication::translate("user_rolewindow", "\320\241\320\274\320\276\321\202\321\200\320\265\321\202\321\214", nullptr));
